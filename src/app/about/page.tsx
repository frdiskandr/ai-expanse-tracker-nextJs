...
const About = () => {
  return (<div className='font-sans bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20 text-gray-800 dark:text-gray-200 transition-all duration-300 min-h-screen'>
    ...
    <section className='relative overflow-hidden flex flex-col items-center justify-center text-center py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-br from-blue-800/10 via-yellow-200/5 to-blue-800/10 dark:from-blue-900/30 dark:via-green-900/20 dark:to-teal-900/30'>
      ...
      <div className='relative z-10 max-w-4xl mx-auto w-full'>
        ...
        <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 text-gray-900 dark:text-gray-100 leading-tight'>
          About{' '}
          <span className='bg-gradient-to-r from-blue-800 via-yellow-200 to-blue-800 bg-clip-text text-transparent'>
            ExpenseTracker AI
          </span>
        </h1>
        ...
        <div className='mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0'>
          ...
          <Link
            href='/contact'
            className='group border-2 border-blue-500/20 dark:border-blue-400/20 text-blue-800 dark:text-blue-800 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold transition-all duration-200 backdrop-blur-sm'
          >
            Learn More
          </Link>
        </div>
    ...
    <section className='py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm relative overflow-hidden'>
      <div className='absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-800 via-yellow-200 to-blue-800'></div>
      <div className='max-w-4xl mx-auto text-center'>
        <div className='inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-800 px-3 py-1 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6'>
          <span className='w-1.5 h-1.5 bg-blue-800 dark:bg-blue-800 rounded-full'></span>
          Our Mission
        </div>
        <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 text-gray-900 dark:text-gray-100 px-2 sm:px-0'>
          ...
          <span className='text-blue-800 dark:text-blue-800'>AI</span>
        </h2>
    ...
    <section className='py-20 px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20'>
      <div className='max-w-6xl mx-auto'>
        <div className='text-center mb-16'>
          <div className='inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-800 px-3 py-1 rounded-full text-sm font-medium mb-6'>
            <span className='w-1.5 h-1.5 bg-blue-800 dark:bg-blue-800 rounded-full'></span>
            Features
          </div>
    ...
    <section className='py-20 px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20 relative overflow-hidden'>
      ...
      <div className='max-w-4xl mx-auto text-center relative z-10'>
        <div className='inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-800 px-4 py-2 rounded-full text-sm font-medium mb-6 shadow-lg'>
          <span className='w-2 h-2 bg-blue-800 dark:bg-blue-800 rounded-full animate-pulse'></span>
        ...
        <div className='flex flex-col sm:flex-row gap-6 justify-center items-center'>
          ...
          <Link
            href='/contact'
            className='group border-2 border-blue-500/20 dark:border-blue-400/20 text-blue-800 dark:text-blue-800 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-8 py-4 rounded-2xl font-semibold transition-all duration-200 backdrop-blur-sm flex items-center gap-2'
          >
            Contact Us
