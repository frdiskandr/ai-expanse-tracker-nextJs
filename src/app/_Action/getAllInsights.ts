...
import { AIInsight, ExpanseRecord, GenerateExpanseInsights } from "@/lib/ai"
...
export async function getAIInsights(): Promise<AIInsight[]> {
    try {
        ...
        const thirtyDatsAgo = new Date();
        thirtyDatsAgo.setDate(thirtyDatsAgo.getDate() - 30);
        ...
        const expensesData: ExpanseRecord[] = expenses.map(expense => ({
            id: expense.id,
